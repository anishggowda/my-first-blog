	...
	<body class="">
			...
			<nav>
				...
				<ul>
					<li class="active open">
						<a href="#" title="Dashboard"><i class="fa fa-lg fa-fw fa-home"></i> <span class="menu-item-parent">Audio Streams</span></a>
						<ul style="display: block;">
							<li class="active">
								<a href="index.html" title="Dashboard"><span class="menu-item-parent">Listing</span></a>
							</li>
							<li>
								<a href="index.html" title="Dashboard"><span class="menu-item-parent">Archive</span></a>
							</li>
		...
		<div id="main" role="main">
			...
			<div id="ribbon">
				...
				<!-- breadcrumb -->
				<ol class="breadcrumb">
					<li>Home</li><li>AUDIO STREAMS</li>
				</ol>
				<!-- end breadcrumb -->
			...
			<div id="content">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
						<h1 class="page-title txt-color-blueDark"><i class="fa-fw fa fa-home"></i> Audio Streams <span>> My AudioStreams</span></h1>
					</div>
				...
				<section id="widget-grid" class="">
					...
					<div class="row">
						...
						<article class="col-sm-12 col-md-12 col-lg-6">
							...
							<!-- new widget -->
							<div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-3" data-widget-colorbutton="false" style="margin-top:-20px">
								...
								<div>
									...
									<div class="widget-body no-padding" style="overflow-y: scroll;height:500px;margin-top:-10px">
										...
										<table class="table table-striped table-hover table-condensed">
											...
											<tbody>
												<?php
  $con1=mysqli_connect("localhost","root","root","task");
...
?>
	...
	<td><input type="checkbox" data-val="<?php  echo $row['license']; ?>" class="check" <?php if($row["monitor"]=="1"){ echo "checked";}?>></td>		
	</tr>
<?php }?>
...
$(document).on("click", ".check", function () {	
 ...
 alert(msg);
                ...
                alert(licenceid+ " In Monitoring state.");
            }
 ...
 alert(msg);
                ...
                alert(licenceId+ " is In Not Monitoring state.");
            }
//end Ajax
});
</script>