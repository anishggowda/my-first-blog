...
if (typeof S3_REGION != 'undefined') {
  var BUCKET_URL = 'https://recordaudiostream/.s3-us-west-2.amazonaws.com'; // e.g. just 's3' for us-east-1 region
        ...
        item =
            {
              ...
              Size: '',
              keyText: 'Back',
              href: S3BL_IGNORE_PATH ? '?prefix=' + up : 'back'
            },
