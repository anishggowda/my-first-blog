...
<html lang="en-us" id="extr-page">
	...
	<body id="login">
		...
		<header id="header">
			...
			<span id="extr-page-header-space"> <span class="hidden-mobile hidden-xs">Already registered?</span> <a href="login.php" class="btn btn-danger">Sign In</a> </span>
  ...
  echo "Failed to connect to MySQL: " . mysqli_connect_error();
               ...
               $sql = "insert into register values('$username', '$email', '$password', '$firstname', '$lastname', '$gender', '$request');";   
